...
export class UserService {
	private readonly loginBroadcastEmit = new BroadcastChannelPolyfill( 'e-make' );
	private readonly loginBroadcastReceive = new BroadcastChannelPolyfill( 'e-make' );
	private readonly tokenSubject = new BehaviorSubject<string | undefined>( undefined );
