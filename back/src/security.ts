...
export const isAuthenticatedMiddleware = ( req: express.Request, res: express.Response, next: () => void ) => {
...
export const isAdminMiddleware = ( req: express.Request, res: express.Response, next: () => void ) => {
	if ( !isAuthenticated( req ) ) {
...
export const writeOnlyForAdmin: ICrudSecurity = {
	delete: isAdminMiddleware,
	insert: isAdminMiddleware,
	update: isAdminMiddleware,
};

export const allOnlyAsAuthorOrAdminMiddleware: ICrudSecurity = {
...
export interface ICrudSecurity {
	find?: RequestHandler;
